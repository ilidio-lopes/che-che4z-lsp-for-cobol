...
dbs_table_name: T=dbs_alias_name {validateByteLength($T.text, "table name", 128);};
dbs_collection_id: dbs_sql_identifier;
dbs_column_name_without_alias: dbs_sql_identifier;
dbs_column_name: T=dbs_column_name_without_alias (DOT_FS dbs_sql_identifier (DOT_FS dbs_sql_identifier (DOT_FS dbs_sql_identifier)?)?)? {validateByteLength($T.text, "column name", 128);};
